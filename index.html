...
/* Figuran table: stack görünümünde daha düzenli */
@media (max-width: 768px){
  #viewFiguran td{
...
<div class="notifPanel hidden" id="notifPanel" role="dialog" aria-label="Bildirimler">
      ...
      <div id="notifBackdrop" class="backdrop hidden" aria-hidden="true"></div>
...
<button class="q-clear" id="qClear" title="Temizle">✕</button>
          ...
          <div class="qScopeOutside" title="Arama kapsamı">
            <select id="qScope" class="q-scope">
...
<div class="seg" title="Görünüm">
    ...
    <div class="card">
      ...
      <div class="bd">
        <div class="filters" style="margin-bottom:10px">
          ...
          <button class="btn" id="dCopy">📋 Excel'e Kopyala</button>
    ...
    <div class="grid" style="grid-template-columns: 1.1fr .9fr">
      <div class="card">
        <div class="hd">
          ...
          <div class="small" id="chartHint">İpucu: grafik dilimine/bara tıkla → sağda liste açılır.</div><div style="margin-left:auto;display:flex;gap:8px;align-items:center"></div>
        </div>
        <div class="bd">
      ...
      <aside class="drawer hidden" id="chartDrawer">
        <div class="hd">
          ...
          <div style="display:flex;gap:8px;align-items:center">
            <button class="btn" id="chartDownloadBtn" title="Grafik + listeyi PDF olarak indir">🧾 PDF</button>
  ...
  <!-- Clipboard / Excel Pano -->
  <div id="clipBackdrop" class="backdrop hidden" aria-hidden="true"></div>
  <div id="clipSheet" class="clipSheet hidden" role="dialog" aria-modal="true" aria-label="Excel Panosu">
    <div class="hd">
      <div>
        <div class="drawerTitle">Excel Panosu</div>
        <div class="drawerSub">Kopyaladığın veriyi buradan seçip tekrar kopyalayabilirsin.</div>
      </div>
      <div style="display:flex;gap:8px;align-items:center">
        <button class="btn" id="clipClose">✕</button>
      </div>
    </div>
    <div class="bd">
      <textarea id="clipText" spellcheck="false"></textarea>
      <div class="small">İpucu: Ctrl+V / Yapıştır ile Excel’e yapıştır.</div>
    </div>
  </div>
